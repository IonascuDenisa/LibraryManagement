...
public class Author {
    ...
    public Author(String name, String literaryMovement, Boolean isAlive, int birthYear, int deathYear, Book[] books) {
        this.name = name;
    ...
    public void printAuthor(){
        ...
        System.out.println("Number of books written:"+books.length);
    }
    public void printbook(int idCheck){
        for(Book i:books){
            if(i.getId() == idCheck){
